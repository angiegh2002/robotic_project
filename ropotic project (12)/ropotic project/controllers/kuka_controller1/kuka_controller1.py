...
class YouBotController(Robot):
    ...
    def rotate_180_degrees(self):
        ...
        self.front_left_wheel.setVelocity(14.0)
        self.back_left_wheel.setVelocity(14.0)
        self.step(1600)  # ضعف وقت الدوران 90 درجة
                ...
                if not has_cube:
                    ...
                    if front_distance == 1:
                        ...
                        while self.step(self.timestep) != -1:
                            ...
                            # التحرك أفقياً مع تغيير الاتجاه
                            self.move_horizontally(direction)
                            if direction == 'right':
                                direction = 'left'
                            else:
                    ...
                    if current_color == "yellow" and l == 1:
                        ...
                        while self.step(self.timestep) != -1:
                            ...
                            if sum(filtered_values) == 0:  # فقدان الخط
                                self.stop()
                                self.release_object()
                                self.rotate_180_degrees()
                                self.step(100)
                                ...
                                break    
                            self.follow_line()
                            # حالات الألوان الأخرى يمكن تعديلها بالمثل...    
